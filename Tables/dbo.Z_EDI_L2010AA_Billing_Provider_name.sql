CREATE TABLE [dbo].[Z_EDI_L2010AA_Billing_Provider_name] (
  ...
  [billing_provider_contact_name] [varchar](60) NULL,
  [contact_function_code] [char](2) NULL,
  [code8] [char](3) NULL,
  [code7_end] [char](1) NULL,
  [billing_provider_additional_id3] [varchar](30) NULL,
  [reference_id_qual3] [char](3) NULL,
  [code7] [char](3) NULL,
  [code6_end] [char](1) NULL,
  [billing_provider_additional_id2] [varchar](50) NULL,
  [reference_id_qual2] [char](3) NULL,
  [code6] [char](3) NULL,
  [code5_end] [char](1) NULL,
  [billing_provider_additional_id] [varchar](50) NULL,
