CREATE TABLE [dbo].[Z_EDI_L2010BA_Subscriber_name] (
  [zip] [varchar](15) NOT NULL,
  [suffix] [varchar](10) NOT NULL,
  [subscriber_additional_id] [varchar](30) NOT NULL,
  ...
  [date_time_format_qual] [char](2) NOT NULL,
