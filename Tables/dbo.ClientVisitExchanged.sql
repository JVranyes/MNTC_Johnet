CREATE TABLE [dbo].[ClientVisitExchanged] (
  ...
  [visittype_id_shadow] [varchar](100) NULL,
  [team_id_shadow] [varchar](100) NULL,
  [program_id_shadow] [varchar](100) NULL,
  [location_id_shadow] [varchar](100) NULL,
  [fosterhome_id_shadow] [varchar](100) NULL,
  [emp_id_shadow] [varchar](100) NULL,
  [appr_emp_id_shadow] [varchar](100) NULL,
  [exchange_source] [varchar](10) NULL,
  ...
  [client_id] [int] NULL,
  [clientvisitexchanged_id] [int] NULL
)
ON [PRIMARY]
GO