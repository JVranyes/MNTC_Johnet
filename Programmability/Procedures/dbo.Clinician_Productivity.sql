...
CREATE PROCEDURE [dbo].[Clinician_Productivity]
...
Order By location_desc, ClientVisit.visittype, ClientVisit.title, Clients.last_name, Clients.first_name, Z_ServiceLedger.accounting_date DESC 


GO

GRANT EXECUTE ON [dbo].[Clinician_Productivity] TO [General]
GO